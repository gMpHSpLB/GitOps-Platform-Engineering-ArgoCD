...
setup-argocd: ## 
	@printf '$(CYAN) %s $(RESET) \n' \
		...
		' 		- Step 5. Register public github repository as gitops source with ArgoCD'; \
	...
	read -r _
	$(MAKE) -f Makefile_Setup_ArgoCD_GitOps_Platform_Engineering register-public-github-repo-as-gitops-source-with-argocd
